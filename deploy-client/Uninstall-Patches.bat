...
echo         Keep Manage-Patches.ps1 and Uninstall-Patches.bat in the same folder.
pause
exit /b 6
:haveps
...
powershell -NoProfile -ExecutionPolicy Bypass -File "%SRC%Manage-Patches.ps1" -Action uninstall %*
set "RC=%ERRORLEVEL%"
